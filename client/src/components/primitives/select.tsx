...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretSortIcon className="h-4 w-4 text-foreground opacity-50" />
